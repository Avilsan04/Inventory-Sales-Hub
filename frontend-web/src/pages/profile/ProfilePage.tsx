...
function roleBadgeVariant(role: RoleKey): 'default' | 'secondary' | 'outline' {
    const map: Record<RoleKey, 'default' | 'secondary' | 'outline'> = {
        admin: 'default', manager: 'secondary', staff: 'outline',
    };
    return map[role];
}
    ...
    const onSubmitPassword = (data: PasswordValues): void => {
        changePassword(
            { currentPassword: data.currentPassword, newPassword: data.newPassword },
            {
                ...
                onError: (err) => { toast({ title: 'Change failed', description: err.message, variant: 'destructive' }); },
            },
        );
    };
        ...
        <div className={baseStyles['page']}>
            ...
            <div className={styles['sections']}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <form onSubmit={(e: React.SyntheticEvent) => { void profileForm.handleSubmit(onSubmitProfile)(e); }}>
                            <div className={styles['formBody']}>
                                <FormField label={t('auth.username')} required error={profileForm.formState.errors.username?.message}>
                                    <Input {...profileForm.register('username')} />
                                </FormField>
                                <FormField label={t('auth.email')} required error={profileForm.formState.errors.email?.message}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <form onSubmit={(e: React.SyntheticEvent) => { void passwordForm.handleSubmit(onSubmitPassword)(e); }}>
                            <div className={styles['formBody']}>
