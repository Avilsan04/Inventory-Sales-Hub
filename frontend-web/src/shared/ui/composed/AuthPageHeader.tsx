...
import styles from '@shared/styles/themes/components/AuthPageHeader.module.scss';
...
export interface AuthPageHeaderProps {
  ...
  readonly forceDarkLogo?: boolean;
}

export function AuthPageHeader({
  onLogoClick,
  forceDarkLogo = false,
}: AuthPageHeaderProps): React.ReactElement {
  ...
  return (
    <header className={styles['header']}>
      <div className={styles['headerContent']}>
        <div data-theme={forceDarkLogo ? 'dark' : undefined} style={{ display: 'contents' }}>
          <Button
            variant="ghost"
          ...
          >
            ...
            >
              <defs>
                <linearGradient id="ish-auth-grad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0" stopColor="#2563eb" />
                  <stop offset="1" stopColor="#1d4ed8" />
                </linearGradient>
              </defs>
              <rect x="0" y="6" width="44" height="44" rx="10" fill="url(#ish-auth-grad)" />
              <rect
                x="0.5"
                y="6.5"
                width="43"
