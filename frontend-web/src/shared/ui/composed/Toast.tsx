...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport ref={ref} className={cn(styles.toastViewport, className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action ref={ref} className={cn(styles.toastAction, className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn(styles.toastTitle, className)} {...props} />
));
