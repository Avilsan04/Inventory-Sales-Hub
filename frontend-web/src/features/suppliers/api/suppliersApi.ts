...
export const suppliersApi = {
  ...
  createOrder: async (supplierId: string, data: CreateSupplierOrderDTO): Promise<SupplierOrder> => {
    const res = await httpClient.post<SupplierOrder>(`/suppliers/${supplierId}/orders`, data);
